...
TaskSource = Literal["manual", "camera"]
TaskPriority = Literal["low", "medium", "high"]


class TaskCreate(BaseModel):
    """Payload for manual tasks and tasks generated by surveillance events."""

    titulo: str = Field(min_length=1, max_length=200)
    estado: TaskStatus = "Pendiente"
    source: TaskSource = "manual"
    camera_id: str | None = Field(default=None, min_length=1, max_length=50)
    event_id: str | None = Field(default=None, min_length=1, max_length=50)
